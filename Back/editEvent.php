...
if (isset($_POST['event_id'])) {
	...
	if (mysqli_num_rows($result) != 1) {
		...
		$event_repeated = (!empty($_POST["event_info"]['event_repeated'])) ? $_POST["event_info"]['event_repeated'] : $event_repeated;
		$event_description = (!empty($_POST["event_info"]['event_description'])) ? $_POST["event_info"]['event_description'] : $event_description;
		$event_calendar = (!empty($_POST["event_info"]['event_calendar'])) ? $_POST["event_info"]['event_calendar'] : $event_calendar;
		$event_location_lat = (!empty($_POST["event_info"]['event_location_lat'])) ? $_POST["event_info"]['event_location_lat'] : $event_location_lat;
		$event_location_long = (!empty($_POST["event_info"]['event_location_long'])) ? $_POST["event_info"]['event_location_long'] : $event_location_long;
